 ...
 */
 //print "ID:". $id . "<br />";
 //print "BLOCK ID:". $block_id . "<br />";
 //print "BLOCK HTML ID:". $block_html_id . "<br />";
...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="<?php ($block_html_id == 'block-block-4')? print "blockwrapper" : print "content"; ?>"<?php print $content_attributes; ?>>
    <?php print $content; ?>
  </div>
