 ...
 * - $page['feature']: Special display at the top of the Home page.
 ...
 * 
 * REPLACEMENTS for DoS, 2011-07-06
 * page-wrapper -> wrapper, then added page-wrapper for full background
 * header -> masthead
 * main-wrapper -> content-well
 */
...
<?php if($mode=='embed'):?>
	...
	<?php if ($title && substr($_SERVER['REQUEST_URI'],0,15)!='/search_results'): ?>
	...
	<div id="wrapper"><div id="page">
	  ...
	  <div id="masthead">
	  	<div class="section clearfix">
			    ...
			    <?php //print theme('links__system_secondary_menu', array( // This is the User menu.
			      //'links' => $secondary_menu,
			      //'attributes' => array(
			      //  'id' => 'utility-nav', /* renamed from 'secondary-menu', 2011-07-06, to match State.gov */
			    ...
			    <?php print render($page['header']); // Header region ?>
			     ...
			     <?php if ($page['navigation'] || $main_menu): // contains Main menu. ?>
